...
class ImportVariantTamanho extends Command
{
    public const ATTRIBUTE_CODE_VARIANT_TAMANHO = 'variant_tamanho';
    public const VARIANT_TAMANHO = 'TAMANHO';
    ...
    {
        $this->setName('omnik:variant-tamanho:import')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->write(__('Starting Import Variant %variant ', ['variant' => self::VARIANT_TAMANHO]));

        $this->state->setAreaCode('global');

        $variantData = $this->getValueByVariant->execute(self::VARIANT_TAMANHO);
