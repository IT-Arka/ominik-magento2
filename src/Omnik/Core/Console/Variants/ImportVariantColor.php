...
class ImportVariantColor extends Command
{
    public const ATTRIBUTE_CODE_VARIANT_COLOR = 'variant_color';
    public const VARIANT_COLOR = 'COR';
    ...
    {
        $this->setName('omnik:variant-color:import')
            ->setDescription('Import values from color variant from omnik');
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->write(__('Starting Import Variant %variant ', ['variant' => self::VARIANT_COLOR]));

        $this->state->setAreaCode('global');

        $variantData = $this->getValueByVariant->execute(self::VARIANT_COLOR);
        ...
        $attributeCode = $this->configHelper->getAttrVariantColor();
